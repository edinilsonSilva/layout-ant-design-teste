    ...
    return (
        <Layout>
            <Header className="header">
                ...
                {/* <Avatar style={{ backgroundColor: color, verticalAlign: 'middle', float:'right', padding: '0px' }} icon="user" size="large" /> */}
            </Header>
            <Layout>
                <Sider width={200} className="site-layout-background">
                    ...
                    >
                        <SubMenu key="sub1" icon={<UserOutlined />} title="Configurações">
                        ...
                        <SubMenu key="sub3" icon={<NotificationOutlined />} title="Fale Conosco">
